...
class MovieAfter extends Component{
...
<div style={{marginTop:"8%"}}>
 ...
 <h3 style={{textDecoration:"underline red",paddingLeft:"3%"}}>公開予定作品</h3>   
<Tabs
   ...
   className="mb-3"
    ...
    >
      <Tab eventKey="all" title="All"  >
        <MovieList  genre="all" state="after"/>
      </Tab>
      <Tab eventKey="action" title="Action"  >
      <MovieList   genre="action" state="after"/>
      </Tab>
      <Tab eventKey="anime" title="Anime" >
      <MovieList   genre="anime" state="after"/>
      </Tab>
      <Tab eventKey="thriller" title="Thriller" >
      <MovieList   genre="thriller" state="after"/>
     </Tab>
     <Tab eventKey="romance" title="Romance" >
     <MovieList   genre="romance" state="after"/>
  </Tab>
  <Tab eventKey="horror" title="Horror" >
     <MovieList   genre="horror" state="after"/>
  </Tab>
  <Tab eventKey="comedy" title="comedy" >
     <MovieList   genre="comedy" state="after"/>
  </Tab>
  <Tab eventKey="SF" title="SF" >
     <MovieList   genre="SF" state="after"/>
  </Tab>
  <Tab eventKey="Fantasy " title="Fantasy " >
     <MovieList   genre="Fantasy " state="after"/>
  </Tab>
    </Tabs>
